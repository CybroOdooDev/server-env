...
class CreateIndexesLine(models.TransientModel):
    ...
    _name = 'cleanup.create.indexes.line'

    purged = fields.Boolean('Created')
    wizard_id = fields.Many2one('cleanup.create.indexes.wizard')
...
class CreateIndexesWizard(models.TransientModel):
    ...
    _name = 'cleanup.create.indexes.wizard'
    _description = 'Create indexes'

    purge_line_ids = fields.One2many(
        'cleanup.create.indexes.line', 'wizard_id',
    )
